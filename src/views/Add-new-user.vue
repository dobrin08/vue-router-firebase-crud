              ...
              <tab name="Step 1" info="Your name and Email" :selected="true" :formData="formData">
                <div id="form-step-1" >
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="email"  type="email"  v-model="formData.email" placeholder="Email input" data-vv-scope="step1" v-validate="'required|email'">
              ...
              <tab name="Step 2" info="Basic Info about you" data-vv-scope="step2">
                <div id="form-step-2">
                  <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="about"  v-model="formData.about" placeholder="Something about you.." v-validate="'required'" data-vv-scope="step2"></textarea>
                  ...
                  <div class="field">
                    <div class="control">
                      ...
                      <label class="radio">
                        <input type="radio" name="gender" v-model="formData.gender" v-validate="'required'" data-vv-scope="step2" value="Male">
                        Male
                      </label>
                      
                      <label class="radio">
                        <input type="radio" name="gender" v-model="formData.gender" data-vv-scope="step2" value="Female">
                        Female
                      </label>
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <div class="select" name="reference">
                        <select v-model="formData.reference" v-validate="'required'" name="reference" data-vv-scope="step3">
